...
public class Main_Console extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main__console, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_messages) {
            fragment = new test_frag();
        } else if (id == R.id.nav_contacts) {
            fragment = new Frag_Contacts();
        } else if (id == R.id.nav_invite) {
            fragment = new Frag_Invite();
        } else if (id == R.id.nav_invitations) {
            fragment = new Frag_Invitations();
